...
try:
    ...
    for step in np.arange(MAX_STEP):
        ...
        _, tes_loss, tes_acc = sess.run([train_op, test_loss, test_acc])
        loss_train.append(tra_loss)
        loss_test.append(tes_loss)
...
plt.plot(np.arange(MAX_STEP), loss_train, c='r')
plt.plot(np.arange(MAX_STEP), loss_test, c='b')
plt.show()